...
export default function CategoryList({sno , id , name , image , url , status , created , home, event}) {
  ...
  return (
        <tr className='border-b'>
          ...
          <td className='flex justify-center items-center'><img src={url+image} alt="" className='mt-2 mb-2 w-[115px] h-[75px]'/></td>
          ...
          <td className='flex justify-center items-center relative bottom-7'>
            <Link to={`/admin-panel/category/update/${id}`}><svg xmlns="http://www.w3.org/2000/svg" className="ml-1 h-6 w-6 " fill="none" viewBox="0 0  24  24" stroke="currentColor" strokeWidth="2">
            <path strokeLinecap="round" strokeLinejoin="round" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
            </svg></Link>
            <button onClick={()=>{Delete(id)}}><svg xmlns="http://www.w3.org/2000/svg" className="ml-10 h-6 w-6 " fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
