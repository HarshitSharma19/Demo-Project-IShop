...
export default function Card({ name ,price ,image,url,discount }) {
    return ( 
            ...
            <img className="rounded-t-lg mb-3 h-[120px] w-[200px]" src={url+image} alt="product"/>
            <hr className='h-5 mt-5' />

            <div className="px-5 pb-5 flex flex-col justify-center ">
                {
                    <h5 className=" flex text-sm font-semibold tracking-tight justify-center mb-4 ">{name}</h5>
                }
                ...
                <span className="text-1xl font-bold text-red-600">{price}</span>
                    <span className="text-1xl text-gray-600 text-decoration: line-through ">{discount}</span>
                </div>
