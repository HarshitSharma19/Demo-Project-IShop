...
export default function CardBox() {
    return ( 
        ...
        <div
            className=" transform hover:scale-125 w-[210px] max-w-sm  bg-white rounded-lg   border  m-2 px-3 py-2 "
            style={{
            border: "3px solid #F6F7F8"
        }}>
            <span className=' w-15 bg-orange-600 font-bold rounded-sm px-2 text-white'>Offer</span>
            <img className="rounded-t-lg transform   mb-3" src={applemc} alt="product"/>
